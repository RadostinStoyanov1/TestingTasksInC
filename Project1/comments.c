...
Задача 7: За решението на задачата се създава масив в динамичната памет, с размер, който се изчислява от функцията calculateNumberOfSymbols. В създадения масив се добавя числото 1 като начало на редицата. След това се итерира по зададения вход, като на всяка итерация към вече създадения стринг от предходната итерация, се прикрепя текущото число на итерацията + стринга от предходната итерация.
	Задачата има втори вариант на решение с рекурсия -  Problem07v2
*/
